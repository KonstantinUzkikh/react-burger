import { WS_CONNECTION_START, WS_CONNECTION_STOP, WS_CONNECTION_OPENED,
  WS_CONNECTION_CLOSED, WS_CONNECTION_ERROR,  WS_GET_MESSAGE
} from "./action-types";
import { WS_AUTH_CONNECTION_START, WS_AUTH_CONNECTION_STOP, WS_AUTH_CONNECTION_OPENED,
  WS_AUTH_CONNECTION_CLOSED, WS_AUTH_CONNECTION_ERROR,  WS_AUTH_GET_MESSAGE
} from "./action-types";
